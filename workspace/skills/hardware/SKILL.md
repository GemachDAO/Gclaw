---
name: hardware
description: Read and control I2C and SPI peripherals on Gemach boards (LicheeRV Nano, MaixCAM, NanoKVM).
...
Most I2C/SPI pins are shared with WiFi on Gemach boards. You must configure pinmux before use.
