...
Thank you for your interest in contributing to Gclaw! This project is a community-driven effort to build the lightweight and versatile personal AI assistant. We welcome contributions of all kinds: bug fixes, features, documentation, translations, and testing.

Gclaw itself was substantially developed with AI assistance — we embrace this approach and have built our contribution process around it.
...
- **Testing** — Run Gclaw on new hardware, channels, or LLM providers and report your results.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/<your-username>/Gclaw.git
   cd Gclaw
   ```
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/GemachDAO/Gclaw.git
   ```
...
Gclaw was built with substantial AI assistance, and we fully embrace AI-assisted development. However, contributors must understand their responsibilities when using AI tools.
