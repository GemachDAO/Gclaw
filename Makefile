...
GCLAW_HOME?=$(HOME)/.gclaw
WORKSPACE_DIR?=$(GCLAW_HOME)/workspace
...
## build-all: Build gclaw for all platforms
build-all: generate
...
## install: Install gclaw to system and copy builtin skills
install: build
...
## uninstall: Remove gclaw from system
uninstall:
...
## uninstall-all: Remove gclaw and all data
uninstall-all:
	@echo "Removing workspace and skills..."
	@rm -rf $(GCLAW_HOME)
	@echo "Removed workspace: $(GCLAW_HOME)"
...
help:
	...
	@echo "  WORKSPACE_DIR           # Workspace directory (default: ~/.gclaw/workspace)"
